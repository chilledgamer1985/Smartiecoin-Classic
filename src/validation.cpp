...
#if defined(NDEBUG)
# error "smartiecoinclassiccoin cannot be compiled without assertions."
#endif
...
const std::string strMessageMagic = "smartiecoinclassic Signed Message:\n";
...
void ThreadScriptCheck() {
    RenameThread("smartiecoinclassic-scriptch");
