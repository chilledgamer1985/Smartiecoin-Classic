...
void Shutdown()
{
    ...
    RenameThread("smartiecoinclassic-shutoff");
...
{
    const std::string URL_SOURCE_CODE = "<https://github.com/smartiecoinclassic-org/smartiecoinclassic>";
    const std::string URL_WEBSITE = "<https://smartiecoinclassic.web4u.jp>";
...
void ThreadImport(std::vector<fs::path> vImportFiles)
{
    ...
    RenameThread("smartiecoinclassic-loadblk");
...
bool AppInitMain()
{
    ...
    if (gArgs.IsArgSet("-datadir") && !fs::path(gArgs.GetArg("-datadir", "")).is_absolute()) {
        LogPrintf("Warning: relative datadir option '%s' specified, which will be interpreted relative to the "
                  "current working directory '%s'. This is fragile, because if smartiecoinclassic is started in the future "
                  "from a different location, it will be unable to locate the current data files. There could "
                  "also be data loss if smartiecoinclassic is started while in a temporary directory.\n",
