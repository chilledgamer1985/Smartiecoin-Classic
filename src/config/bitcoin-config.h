...
/* Copyright holder(s) */
#define COPYRIGHT_HOLDERS_FINAL "The Smartiecoinclassic Core developers"

/* Replacement for %s in copyright holders string */
#define COPYRIGHT_HOLDERS_SUBSTITUTION "Smartiecoinclassic Core"
...
#define PACKAGE_BUGREPORT "https://github.com/smartiecoinclassic-org/smartiecoinclassic/issues"

/* Define to the full name of this package. */
#define PACKAGE_NAME "Smartiecoinclassic Core"

/* Define to the full name and version of this package. */
#define PACKAGE_STRING "Smartiecoinclassic Core 1.0.2.2"

/* Define to the one symbol short name of this package. */
#define PACKAGE_TARNAME "smartiecoinclassic"

/* Define to the home page for this package. */
#define PACKAGE_URL "https://smartiecoinclassic.web4u.jp/"
